...
Эти формулы фиксируют акорень, группировку, последовательность, прямоассоциативное чтение последовательностей, самозамкнутые виды форм и смысл конструктора связи через последовательность смыслов абитов.
...
- [Шаблонный поиск МТС](docs/specs/Шаблонный%20поиск%20МТС.md) — правила `{}`, `{s}` и исполнения шаблона.
