...
Квадратные скобки закреплены за ачислами и слоем сериализации. Историческая запись `[⟼]` относится к архивному и исследовательскому слою, а не к базовому синтаксису нового ядра.
