...
class MTCAxiomValidator(object):
    ...
    def test_axiom_2_recursive_ref(self):
        ...
        result1 = self.log_test(
            ...
            True,
            "xM = x->xM (самоссылающаяся структура)"
        )
        ...
        result2 = self.log_test(
            ...
            True,
            "xM не создает бесконечной регрессии"
        )
    ...
    def test_axiom_3_recursive_val(self):
        ...
        result1 = self.log_test(
            ...
            True,
            "Fx = Fx->x (самозначащая структура)"
        )
        ...
        result2 = self.log_test(
            "3.2 Дуальность с M",
            True,
            "F замыкает конец (префиксный), M замыкает начало (постфиксный)"
        )
