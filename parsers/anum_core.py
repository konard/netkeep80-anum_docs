# -*- coding: utf-8 -*-
"""
Общие базовые классы выражений МТС (anum_core).

Этот модуль содержит базовые классы абстрактного синтаксического дерева (AST)
выражений МТС, которые ранее дублировались между ``anum_prover.py`` и
``mtc_formula_prover.py``. Вынесение их в общий модуль устраняет дублирование
кода (см. issue netkeep80/anum_docs#46) и гарантирует единое поведение
сравнения и хеширования выражений во всех парсерах/доказателях.
...
структуры данных, общие для всех реализаций.
"""
